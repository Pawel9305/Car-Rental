...
public class UserRegisterForm extends FormLayout {
    ...
    public UserRegisterForm(MainView mainView, UserService userService) {
    ...
    private void save() {
        userService.addUser(new UserDto(name.getValue(), surname.getValue(), idNumber.getValue(), email.getValue()));
    }
}
